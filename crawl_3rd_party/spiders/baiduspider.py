...
class BaiduspiderSpider(CrawlSpider):
    ...
    start_urls = ['https://shouji.baidu.com/software/510_board_100_023/','https://shouji.baidu.com/software/509/','https://shouji.baidu.com/software/505_board_100_035/']
    # 运动健身
    ...
    rules = (
        Rule(LinkExtractor(allow=('https://shouji.baidu.com/software/510_board_100_023/',)), follow=False,
             callback='parse_link'),
        Rule(LinkExtractor(allow=('https://shouji.baidu.com/software/509/',)), follow=False,
             callback='parse_link'),
        Rule(LinkExtractor(allow=('https://shouji.baidu.com/software/505_board_100_035/',)), follow=False,
             callback='parse_link'),
    ...
    def parse_link(self, response):
        ...
        if response.url.startswith('https://shouji.baidu.com/software/505_board_100_035/'):
            category = 'baidu_新闻'
        elif response.url.startswith('https://shouji.baidu.com/software/510_board_100_023/'):
            category = 'baidu_购物'
        elif response.url.startswith('https://shouji.baidu.com/software/509/'):
            category = 'baidu_旅游'
        for url in urls:
            yield scrapy.Request(url='https://shouji.baidu.com' + url, callback=self.parse_item,cb_kwargs=dict(category=category))
